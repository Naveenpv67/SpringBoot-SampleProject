...
@Entity
@Table(name = "flexcube_pay_transactions")
@Data
public class FlexcubePayTransactionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

    @Id
    @SequenceGenerator(name = "flexcube_pay_transaction_id_seq", sequenceName = "flexcube_pay_transaction_id_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "flexcube_pay_transaction_id_seq")
    private Long id;
