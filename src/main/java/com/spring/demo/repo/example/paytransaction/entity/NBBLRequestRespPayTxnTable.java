...
@Entity
@Table(name = "nbbl_request_resp_pay_txn_table")
@NamedQuery(name = "NBBLRequestRespPayTxnTable.findAll", query = "SELECT n FROM NBBLRequestRespPayTxnTable n")
@Data
public class NBBLRequestRespPayTxnTable implements Serializable {
    private static final long serialVersionUID = 1L;

    @Id
    @SequenceGenerator(name = "nbbl_request_resp_pay_txn_table_ID_SEQ", sequenceName = "nbbl_request_resp_pay_txn_table_ID_SEQ", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "nbbl_request_resp_pay_txn_table_ID_SEQ")
    private Integer id;
    ...
    @Column(name = "nbbl_response_ts")
    private Timestamp nbblResponseTs;
